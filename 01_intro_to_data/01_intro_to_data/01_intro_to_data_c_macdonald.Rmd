...
Do \texttt{height} and \texttt{weight} appear to be associated? Yes, they do.
...
5. BMI is calculated as weight in kilograms divided by height squared. Create a new variable \texttt{bmi} and make a scatterplot of \texttt{height} and \texttt{BMI}. Do \texttt{height} and \texttt{BMI} seem to be associated? Yes, they do
...
They chose BMI because it's a more efficient way to avaluate someone's obesity level. I person who's 5'3 and 200 lbs is obviosly going to have a higher body fat percentage than someone who is 6'3 and 200 lbs. Taking one's height into account is able to produce a more accurate evaluation of someone's weight.
